...
const routes: Routes = [
  ...
  { path: 'main', loadChildren: () => import('./home/home.module').then( m => m.HomePageModule)},
  {
    path: 'splash',
  ...
  {
    path: 'phoneverify',
    loadChildren: () => import('./pages/phoneverify/phoneverify.module').then( m => m.PhoneverifyPageModule)
  },
  {
    path: 'loginsplash',
    loadChildren: () => import('./pages/loginsplash/loginsplash.module').then( m => m.LoginsplashPageModule)
  },
  {
    path: 'home',
  ...
  {
    path: 'offerdetail',
    loadChildren: () => import('./pages/offerdetail/offerdetail.module').then( m => m.OfferdetailPageModule)
  },
  {
    path: 'qrcode',
